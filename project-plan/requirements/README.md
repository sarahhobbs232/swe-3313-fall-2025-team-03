...
The detailed requirements that were elicited from the aforementioned conversation are detailed ['here'](requirements/elicitation.md)
...
## 📊 Documentation Links 
**Full Requirements:** 
- Click [`here`](requirements/README.md) for the full outline of the requirements.
